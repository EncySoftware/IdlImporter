...
namespace SIL.IdlImporterTool
{
	...
	public class IDLImporter
	{
		...
		private static CodeCommentStatementCollection AddFileBanner(string sInFile, string sOutFile, bool encyMode)
		{
			var cr = encyMode ? "Ency LLC" : "SIL International";
			return new CodeCommentStatementCollection {
				new CodeCommentStatement(
$@"--------------------------------------------------------------------------------------------
 Copyright (c) {DateTime.Now.Year}, {cr}. All rights reserved.

 File: {Path.GetFileName(sOutFile)}
 Responsibility: Generated by IDLImporter
 Last reviewed:

 <remarks>
 Generated by IDLImporter from file {Path.GetFileName(sInFile)}
...
--------------------------------------------------------------------------------------------"
		...
		/// <param name="cnamespace">The namespace definition with all classes and methods.</param>
		/// ------------------------------------------------------------------------------------
		private static void GenerateCode(string sOutFile, CodeNamespace cnamespace, bool encyMode)
		{
